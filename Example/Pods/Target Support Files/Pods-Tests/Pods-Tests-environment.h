...
// MutableDeepCopy
#define COCOAPODS_POD_AVAILABLE_MutableDeepCopy
#define COCOAPODS_VERSION_MAJOR_MutableDeepCopy 0
#define COCOAPODS_VERSION_MINOR_MutableDeepCopy 1
#define COCOAPODS_VERSION_PATCH_MutableDeepCopy 0
